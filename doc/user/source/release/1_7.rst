...
.. note::
    ...
    Diese Release Notes sind ein Arbeitsstand.
     ...
     - Berücksichtigt sind Commits im smarthome Repository bis incl. 23. Feb 2020 (Services: Row 'Node-Red service' is only shown, if ...)
     - Berücksichtigt sind Commits im plugins Repository bis incl. 23. Jan 2020 (msinn: Merge branch 'develop' of https://github.com/smarthomeNG/plugins into…)
