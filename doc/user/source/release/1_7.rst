...
* Interface Plugins
  ...
  * netio230b - classic plugin, not used according to survey
  * smawb - classic plugin, not used according to survey

* Web Plugins

  * alexa - switch to the **alexa4p3** plugin
  * boxcar - classic Plugin, not used according to survey
  * mail - switch to the **mailsend** and **mailrcv** plugin
  * openenergymonitor - classic plugin, not used according to survey
  * wunderground - the free API is not provided anymore by Wunderground


The following plugins are marked as *deprecated* with SmartHomeNG v1.7, because no users and testers has been found:
